<%@ Page Title="" Language="C#" MasterPageFile="~/n2.Master" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="CampusNavigationWeb.AddUser" %>
...
<div class="box">
                ...
                <asp:Label runat="server" ID="lblHeading" Text="Add New User" />
                </div></div>
...
<table class="tblStyle" width=100% rules="rows" border="1" cellpadding="10" cellspacing="5" runat="server" ID="tblMain"
       ...
       <tr valign="top">
            <td> <asp:Label ID="Label1" runat="server" Text="Password" /> </td>
            <td> <asp:TextBox runat="server" ID="txtPassword" TextMode="Password" ClientIDMode="Static" MaxLength="20"  Width="250" /> 
            </td>
       </tr>

    
       <tr valign="top">
            <td> <asp:Label ID="Label3" runat="server" Text="Details" /> </td>
            <td> <asp:TextBox runat="server" ID="txtDetails" ClientIDMode="Static" MaxLength="100"  Width="250" /> 
            </td>
       </tr>
       ...
       <tr>
            ...
            <asp:Button ID="btnSave" CssClass="subbutton1" runat="server" UseSubmitBehavior="false" CommandName="btnSave"
                Text="Update & New User"  ClientIDMode="Static" onclick="btnSave_Click" OnClientClick="javascript:return validate(this);" />
                <br /></td>
        </tr>
